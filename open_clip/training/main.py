...
from open_clip.training.data import get_data
from open_clip.training.distributed import is_master, init_distributed_device, broadcast_object
from open_clip.training.logger import setup_logging
from open_clip.training.params import parse_args
from open_clip.training.scheduler import cosine_lr, const_lr, const_lr_cooldown
from open_clip.training.train import train_one_epoch, evaluate, test
from open_clip.training.file_utils import pt_load, check_exists, start_sync_process, remote_sync
from open_clip.training.evaluate import zero_shot_evaluatation, linear_probing_evaluation
...
def main(args):
    ...
    if args.use_bnb_linear is not None:
        ...
        from open_clip.open_clip.utils import replace_linear
    ...
    if args.use_bnb_linear is not None:
        from open_clip.open_clip.utils import convert_int8_model_to_inference_mode
