...
class ModelArguments:
    model_name_or_path: str = field(
        ...
        default="/Users/zhangyf/llm/Qwen3-0.6B",
...
class DataArguments:
    data_path: str = field(
        default="/Users/zhangyf/PycharmProjects/cfel/deepseekocr/data/deepseek_ocr_ecg_future.jsonl",
...
def main():
    ...
    missing_keys, unexpected_keys = model.model.ecg_encoder.load_state_dict(
        torch.load("/Users/zhangyf/PycharmProjects/cfel/deepseekocr/test/ecg_encoder.pth"))
    ...
    #         if "sam_model" in name or "vision_model" in name or "ecg_encoder" in name or "model.layers" in name:
    #             param.requires_grad = False
    #         else:
